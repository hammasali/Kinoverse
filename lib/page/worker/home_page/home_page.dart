...
import 'package:kinoverse/page/worker/home_page/contract_tab.dart';
import 'package:kinoverse/page/worker/home_page/jobs_tab.dart';
import 'package:kinoverse/page/worker/home_page/message_tab.dart';
import 'package:kinoverse/page/worker/home_page/proposal_tab.dart';
...
class _HomePageState extends State<HomePage> {
  final tabNames = ["Jobs", "Proposals", "Contracts", "Messages", "Alerts"];
  int _currentTab = 0;
            ...
            child: InkWell(
              ...
              child: PopupMenuButton<String>(
                ...
                onSelected: (val) {
                  print("$val clicked");
                  if (val == "my jobs") {
                    CommonRoutePage().gotoMyJobs(context);
                  }
                },
        ...
        child: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
                icon: Icon(Icons.note_add), label: "Proposals"),
            BottomNavigationBarItem(
                icon: Icon(Icons.list_alt), label: "Contracts"),
            BottomNavigationBarItem(
